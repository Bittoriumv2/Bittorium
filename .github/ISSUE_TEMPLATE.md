...
This issue tracker is only for technical issues related to BTOR Core.
General BTOR questions and/or support requests and are best directed to the [BTOR Discord](https://discord.gg/aMF2vUF).
...
### What version of BTOR Core are you using?
