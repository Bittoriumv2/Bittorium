Contributing to Bittorium Core
============================

The Bittorium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bittorium Core project, and is not to be
confused with overall PIVX Network Protocol consensus changes.

Whether a pull request is merged into Bittorium Core rests with the project merge
...
The project leader is the release manager for each Bittorium Core release.
