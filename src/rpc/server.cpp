...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop bittorium server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "bittorium server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* bittorium features */
        {"bittorium", "masternode", &masternode, true, true, false},
        {"bittorium", "listmasternodes", &listmasternodes, true, true, false},
        {"bittorium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bittorium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bittorium", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bittorium", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bittorium", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bittorium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bittorium", "masternodedebug", &masternodedebug, true, true, false},
        {"bittorium", "startmasternode", &startmasternode, true, true, false},
        {"bittorium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bittorium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bittorium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bittorium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bittorium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bittorium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bittorium", "mnbudget", &mnbudget, true, true, false},
        {"bittorium", "preparebudget", &preparebudget, true, true, false},
        {"bittorium", "submitbudget", &submitbudget, true, true, false},
        {"bittorium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bittorium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bittorium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bittorium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bittorium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bittorium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bittorium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bittorium", "checkbudgets", &checkbudgets, true, true, false},
        {"bittorium", "mnsync", &mnsync, true, true, false},
        {"bittorium", "spork", &spork, true, true, false},
        {"bittorium", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbittoriumseed", &getzbittoriumseed, false, false, true},
        {"zerocoin", "setzbittoriumseed", &setzbittoriumseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbittorium", &searchdzbittorium, false, false, true},
        {"zerocoin", "dzbittoriumstate", &dzbittoriumstate, false, false, true}
...
{
    return "> bittorium-cli " + methodname + " " + args + "\n";
}
