...
/**
 * bittorium RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzbittoriumseed(const UniValue& params, bool fHelp);
extern UniValue getzbittoriumseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbittorium(const UniValue& params, bool fHelp);
extern UniValue dzbittoriumstate(const UniValue& params, bool fHelp);
