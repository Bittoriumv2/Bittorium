...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bittorium Core bittorium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bittorium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bittorium transaction") + "\n" +
                               "  bittorium-tx [options] -create [commands]   " + _("Create hex-encoded bittorium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bittorium transaction
