                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBTORPathCustom = GetArg("-zbtorbackuppath", "");
    ...
    if(!strzBTORPathCustom.empty()) {
        ui->wallet_customzbtorbackuppath->setText(QString::fromStdString(strzBTORPathCustom));
        ui->wallet_customzbtorbackuppath_label->setVisible(true);
        ui->wallet_customzbtorbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBTORPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BTOR RPC console.") + "<br>" +
