...
/** Utility functions used by the Bittorium Qt UI.
 */
namespace GUIUtil
{
...
// Render BTOR addresses in monospace font
...
// Parse "bittorium:" URI into recipient object, return true on successful parsing
