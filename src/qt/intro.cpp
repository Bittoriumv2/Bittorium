...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bittorium Core"),
     ...
     * override -datadir in the bittorium.conf file in the default data directory
     * (to be consistent with bittoriumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
