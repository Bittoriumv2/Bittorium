...
/* Bittorium GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Bittorium"
#define QAPP_ORG_DOMAIN "bittorium.org"
#define QAPP_APP_NAME_DEFAULT "Bittorium-Qt"
#define QAPP_APP_NAME_TESTNET "Bittorium-Qt-testnet"
