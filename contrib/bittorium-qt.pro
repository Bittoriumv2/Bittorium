...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/bittorium-cli.cpp \
           src/bittorium-tx.cpp \
           src/bittorium.cpp \
           src/db.cpp \
           ...
           src/qt/bittorium.cpp \
           src/qt/bittoriumstrings.cpp \
...
RESOURCES += src/qt/bittorium.qrc src/qt/bittorium_locale.qrc

TRANSLATIONS += src/qt/locale/bittorium_bg.ts \
                src/qt/locale/bittorium_de.ts \
                src/qt/locale/bittorium_en.ts \
                src/qt/locale/bittorium_es.ts \
                src/qt/locale/bittorium_fi.ts \
                src/qt/locale/bittorium_fr.ts \
                src/qt/locale/bittorium_it.ts \
                src/qt/locale/bittorium_ja.ts \
                src/qt/locale/bittorium_pl.ts \
                src/qt/locale/bittorium_pt.ts \
                src/qt/locale/bittorium_ru.ts \
                src/qt/locale/bittorium_sk.ts \
                src/qt/locale/bittorium_sv.ts \
                src/qt/locale/bittorium_vi.ts \
                src/qt/locale/bittorium_zh_CN.ts \
                src/qt/locale/bittorium_zh_TW.ts
