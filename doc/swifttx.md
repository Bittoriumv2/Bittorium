...
This mechanism has been integrated into Bitcore-Node-bittorium which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bittorium/insight-api-bittorium#web-socket-api](https://github.com/bittorium/insight-api-bittorium#web-socket-api) 
* API: [https://github.com/bittorium/insight-api-bittorium#swifttx-transactions](https://github.com/bittorium/insight-api-bittorium#swifttx-transactions) 
...
By default, the bittorium Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the bittorium Core daemon:
