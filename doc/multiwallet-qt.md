...
In order to support loading of multiple wallets in bittorium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bittorium.cpp.
...
Changes to bittorium.cpp
----------------------
bittorium.cpp is the entry point into bittorium-qt, and as such, will require some minor modifications to provide hooks for
